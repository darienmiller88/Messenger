...
const generateId = function(){
  ...
  return buf.toString(String.fromCharCode.apply(null, buf));
};

const mapValues = function(obj) {
  return Object.keys(obj).map(function (key) {return obj[key]});
};

const newSocket = function(ns, transport){
  var socket = {
    id: generateId(),
    namespace: ns,
    actions: [],
...
const newTransport = function(url){
  var transport = {
    sockets: [],
    duration: 1000
  };
...
var transports = {};
const getTransport = function(url){
